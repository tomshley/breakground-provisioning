module "provisioning-generic-organization-github" {
 ...
 module "provisioning-generic-organization-gitlab" {
   ...
   git_projects_with_parent = [
     ...
     (["dbflags-java-example", "tomshley/brands/global/tware/tech/examples", "", "private"])
   ]
   git_project_mirrors = [
     ...
     (["dbflags-java-example", module.provisioning-generic-organization-github.gh_repositories["dbflags-java-example"].http_clone_url]),
   ]
