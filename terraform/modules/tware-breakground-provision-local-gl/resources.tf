...
module "tware-breakground-provision-organization-github" {
  ...
  git_projects_with_parent = [(["tware-breakground-provisioning", "tomshley", "tomshley"])]
}
...
module "tware-hexagonal-gitlab" {
  ...
  git_project_mirrors = [
         (["breakground-provisioning", module.tware-breakground-provision-organization-github.gh_repositories["tware-breakground-provisioning"].http_clone_url])
  ]
}
