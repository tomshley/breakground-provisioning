 ...
 module "tware-gitlab" {
   ...
   gitlab_projects_with_parent = [
     (["gateway-claimcheck-scala", "tomshley/brands/global/tware/tech/products/gateway", "69749675"]), # path, parent, existing id
     (["gateway-registry-scala", "tomshley/brands/global/tware/tech/products/gateway", "69749675"]), # path, parent, existing id
